...
@section('title', 'Login Admin - Seafood 2000')
    ...
    <div class="bg-slate-900 text-slate-100 rounded-3xl border border-slate-800 shadow-2xl p-8 relative overflow-hidden">
        ...
        <div class="text-center mb-8 relative z-10">
            <span class="inline-flex items-center justify-center p-2.5 bg-slate-800 rounded-2xl border border-slate-700 mb-4 text-teal-400">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0V10.5m-2.25 10.5h13.5c.621 0 1.125-.504 1.125-1.125V11.25c0-.621-.504-1.125-1.125-1.125H5.25c-.621 0-1.125.504-1.125 1.125v7.875c0 .621.504 1.125 1.125 1.125Z" />
                </svg>
            </span>
            <h2 class="text-2xl font-black text-white">Portal Administrator</h2>
        ...
        <form action="{{ route('admin.login') }}" method="POST" class="space-y-6 relative z-10">
            ...
            <div class="bg-amber-950/20 border border-amber-500/20 rounded-xl p-3 text-xs text-amber-300 font-medium">
                ⚠️ Hanya untuk administrator resmi. Segala aktivitas masuk dicatat dalam log keamanan.
            </div>
        ...
        <div class="border-t border-slate-800/80 mt-8 pt-6 text-center relative z-10">
            <a href="{{ route('menu.index') }}" class="text-xs font-bold text-slate-400 hover:text-white transition-colors flex items-center justify-center gap-1.5">
